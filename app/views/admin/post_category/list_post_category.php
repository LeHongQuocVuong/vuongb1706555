    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 bg-light">
                ...
                ?>
                <h2 class="my-2" style="text-align: center;">Danh sách danh mục bài viết</h2>

                <p><a href="<?php echo BASE_URL; ?>post_category/add_post_category" class="btn btn-xs btn-primary">
                    ...
                    <tbody>
                        ...
                        foreach ($category as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $value['desc_post_category']; ?></td>
                                <td>
                                    <a href="<?php echo BASE_URL; ?>post_category/show_update_post_category/<?php echo $value['id_post_category']; ?>" class="btn btn-xs btn-warning">
                                        <i alt="Edit" class="fa fa-pencil"> Sửa</i></a>

                                    <button data-idCategoryProduct="<?php echo $value['id_post_category']; ?>" data-url="<?php echo BASE_URL; ?>post_category/delete_post_category/<?php echo $value['id_post_category']; ?>" class="btn btn-xs btn-danger btn-delete-CategoryProduct">
