    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 bg-light">
                ...
                ?>
                <h2 class="my-2" style="text-align: center;">Danh sách Hình thức thanh toán</h2>

                <p><a href="<?php echo BASE_URL; ?>hinhthucthanhtoan/add_hinhthucthanhtoan" class="btn btn-xs btn-primary">
                ...
                <table id="datatables" style="text-align: center;" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                        <?php
                        $stt = 0;
                        foreach ($hinhthucthanhtoan as $key => $value) {
                            $stt++; ?>
                            <tr>
                                <td><?php echo $stt; ?></td>
                                <td><?php echo $value['httt_ten']; ?></td>
                                <td><?php echo $value['httt_desc']; ?></td>
                                <td>
                                    <a href="<?php echo BASE_URL; ?>hinhthucthanhtoan/show_update_hinhthucthanhtoan/<?php echo $value['httt_ma']; ?>" class="btn btn-xs btn-warning">
                                        <i alt="Edit" class="fa fa-pencil"> Sửa</i></a>

                                    <button data-idhinhthucthanhtoanProduct="<?php echo $value['httt_ma']; ?>" data-url="<?php echo BASE_URL; ?>hinhthucthanhtoan/delete_hinhthucthanhtoan/<?php echo $value['httt_ma']; ?>" class="btn btn-xs btn-danger btn-delete-CategoryProduct">
