    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 bg-light">
                ...
                ?>
                <h2 class="my-2" style="text-align: center;">Danh sách danh mục sản phẩm</h2>

                <p><a href="<?php echo BASE_URL; ?>category/add_category_product" class="btn btn-xs btn-primary">
                    ...
                    <tbody>
                        ...
                        foreach ($category as $key => $value) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo BASE_URL; ?>category/show_update_category_product/<?php echo $value['id_category_product']; ?>" class="btn btn-xs btn-warning">
                                        <i alt="Edit" class="fa fa-pencil"> Sửa</i></a>

                                    <button data-idCategoryProduct="<?php echo $value['id_category_product']; ?>" data-url="<?php echo BASE_URL; ?>category/delete_category_product/<?php echo $value['id_category_product']; ?>" class="btn btn-xs btn-danger btn-delete-CategoryProduct">
