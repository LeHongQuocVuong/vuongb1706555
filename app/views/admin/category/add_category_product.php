    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 bg-light">
                ...
                // }
                ?>
                <h2 class="my-2" style="text-align: center;">Thêm danh mục sản phẩm</h2>
                <form action="<?php echo BASE_URL; ?>category/insert_category_product" method="POST" class="my-2">
                    <div class="form-group">
                        <label for="title_category_product">Tên danh mục sản phẩm</label>
                        <input type="text" class="form-control" id="title_category_product" name="title_category_product" placeholder="Tên danh mục sản phẩm">
                    </div>
                    <div class="form-group">
                        <label for="desc_category_product">Mô tả danh mục sản phẩm</label>
                        <textarea class="form-control" id="desc_category_product" name="desc_category_product" rows="3"></textarea>
                    </div>
