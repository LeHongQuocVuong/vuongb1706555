    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 bg-light">
                ...
                // }
                ?>
                <h2 class="my-2" style="text-align: center;">Thêm bài viết</h2>
                <form action="<?php echo BASE_URL; ?>post/insert_post" method="POST" enctype="multipart/form-data" class="my-2">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="title_post">Tên bài viết</label>
                            <input type="text" class="form-control" id="title_post" name="title_post" placeholder="Tên bài viết">
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="id_post_category" class="custom-select">
                                ...
                                <?php foreach ($category as $key => $value) { ?>
                                    <option value="<?php echo $value['id_post_category']; ?>"><?php echo $value['title_post_category']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <div class="preview-img-container">
                            <img src="<?php echo BASE_URL; ?>public/uploads/posts/default-image_600.png" id="preview-img" width="200px" />
                        </div>

                        <!-- Input cho phép người dùng chọn FILE -->
                        <input type="file" class="form-control" id="name_product_image" name="image_name_post">
                    </div>

                    <div class="form-group col-md-12">
                        <label for="desc_post_ckeditor">Chi tiết bài viết</label>
                        <textarea class="form-control" id="desc_post_ckeditor" name="desc_post" rows="10"></textarea>
                    </div>
