...
<body class="d-flex flex-column h-100">
    ...
    <div class="container pt-2 filters text-center" style="background-color: white;">
        ...
        <div class="btn-group button-group flex-wrap flex-md-nowrap" role="group" aria-label="Basic example" data-filter-group="HDT">
            ...
            <button type="button" class="btn btn-outline-primary" data-type=".type1" title="IPad">
                <img src="<?php echo BASE_URL; ?>app/views/home/assets/img/logo/IPad.jpg" class="img-fluid d-none d-sm-block" alt="">
                <div class="d-sm-none d-block">IPad</div>
            </button>
            ...
            <button type="button" class="btn btn-outline-primary" data-type=".type3" title="Huawei">
                <img src="<?php echo BASE_URL; ?>app/views/home/assets/img/logo/Huawei.jpg" class="img-fluid d-none d-sm-block" alt="">
                <div class="d-sm-none d-block">Huawei</div>
            </button>


            <button type="button" class="btn btn-outline-primary" data-type=".type4" title="Xiaomi">
                <img src="<?php echo BASE_URL; ?>app/views/home/assets/img/logo/Xiaomi.jpg" class="img-fluid d-none d-sm-block" alt="">
        ...
        <div class="row row-cols-1 row-cols-md-4 bg-white IsoTope">
            <?php foreach ($product as $dienthoai) : ?>
                <div class="col a-product border pb-3 all btnGiaAll
                        ...
                        elseif ($dienthoai['id_product_producer'] == 4) echo "type3 ";
