    ...
    <div class="container pt-2 filters  text-center" style="background-color: white;">
        ...
        <div class="btn-group button-group flex-wrap flex-md-nowrap" role="group" aria-label="Basic example" data-filter-group="HDT">
            ...
            <button type="button" class="btn btn-outline-primary" data-type=".type1" title="Iphone">
                <img src="<?php echo BASE_URL; ?>app/views/home/assets/img/logo/iPhone.jpg" class="img-fluid d-none d-sm-block" alt="">
            ...
            <button type="button" class="btn btn-outline-primary" data-type=".type5" title="Vsmart">
                <img src="<?php echo BASE_URL; ?>app/views/home/assets/img/logo/Vsmart.png" class="img-fluid d-none d-sm-block" alt="">
        ...
        <div class="row row-cols-1 row-cols-md-4 bg-white IsoTope">
            <?php foreach ($product as $dienthoai) : ?>
                <div class="col a-product border pb-3 all btnGiaAll
                        ...
                        elseif ($dienthoai['id_product_producer'] == 3) echo "type3 ";
                        elseif ($dienthoai['id_product_producer'] == 12) echo "type4 ";
                        elseif ($dienthoai['id_product_producer'] == 11) echo "type5 ";
