...
<body class="d-flex flex-column h-100">
    ...
    <div class="container pt-2 filters text-center" style="background-color: white;">
        ...
        <div class="btn-group button-group flex-wrap flex-md-nowrap" role="group" aria-label="Basic example" data-filter-group="HDT">
            ...
            <button type="button" class="btn btn-outline-primary" data-type=".type1" title="Macbook">
                <img src="<?php echo BASE_URL; ?>app/views/home/assets/img/logo/Macbook.png" class="img-fluid d-none d-sm-block" alt="">
                <div class="d-sm-none d-block">Macbook</div>
            </button>


            <button type="button" class="btn btn-outline-primary" data-type=".type2" title="Dell">
                <img src="<?php echo BASE_URL; ?>app/views/home/assets/img/logo/Dell.jpg" class="img-fluid d-none d-sm-block" alt="">
                <div class="d-sm-none d-block">Dell</div>
            </button>


            <button type="button" class="btn btn-outline-primary" data-type=".type3" title="HP">
                <img src="<?php echo BASE_URL; ?>app/views/home/assets/img/logo/HP.jpg" class="img-fluid d-none d-sm-block" alt="">
                <div class="d-sm-none d-block">HP</div>
            </button>
            ...
            <button type="button" class="btn btn-outline-primary" data-type=".type5" title="Lenovo">
                <img src="<?php echo BASE_URL; ?>app/views/home/assets/img/logo/Lenovo.jpg" class="img-fluid d-none d-sm-block" alt="">
                <div class="d-sm-none d-block">Lenovo</div>
            </button>
        ...
        <div class="row text-center pt-2" style="background-color: white;">
            ...
            <div class="col-md-6 pl-0">
                <div class="btn-group button-group" role="group" aria-label="Basic example" data-filter-group="Gia">
                    ...
                    <button type="button" class="btn btn-primary btnGia btnGia1" data-type=".Duoi20" title="Dưới 20 triệu">
                        Dưới 20 triệu
                    </button>
                    <button type="button" class="btn btn-primary btnGia btnGia2" data-type=".20_30" title="Từ 20 triệu đến 30 triệu">
                        Từ 20 triệu đến 30 triệu
                    </button>
                    <button type="button" class="btn btn-primary btnGia btnGia3" data-type=".Tren30" title="Trên 30 triệu">
                        Trên 30 triệu
                    </button>
        ...
        <div class="row row-cols-1 row-cols-md-4 bg-white IsoTope">
            <?php foreach ($product as $dienthoai) : ?>
                <div class="col a-product border pb-3 all btnGiaAll
                        ...
                        elseif ($dienthoai['id_product_producer'] == 6) echo "type2 ";
                        elseif ($dienthoai['id_product_producer'] == 7) echo "type3 ";
                        elseif ($dienthoai['id_product_producer'] == 5) echo "type4 ";
                        elseif ($dienthoai['id_product_producer'] == 8) echo "type5 ";
                        if ($dienthoai['price_product'] < 20000000) echo "Duoi20";
                        elseif ($dienthoai['price_product'] < 30000000) echo "20_30";
                        else echo "Tren30";
                        ?>
                        ">
